...
class UnicoreOptimizer(object):
    ...
    def optimizer(self):
        ...
        if not isinstance(self._optimizer, paddle.optimizer.Optimizer):
    ...
    def load_state_dict(self, state_dict, optimizer_overrides=None):
        ...
        optimizer args.
        """
        self.optimizer.set_state_dict(state_dict=state_dict)
    ...
    def per_sample_clip_grad_norm(self, max_norm, aggregate_norm_fn=None):
        ...
        if self._grad_buffer is None:
            self._grad_buffer = [paddle.zeros_like(x=g) for g in self.params]
