...
from unicore.data import (AppendTokenDataset, Dictionary, EpochShuffleDataset,
                          ...
                          RawArrayDataset, RawLabelDataset, RawNumpyDataset,
...
class UniMOFV2Task(UnicoreTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--finetune-mol-model", help="load unimat finetune model")
    ...
    def build_model(self, args):
        ...
        if args.finetune_mol_model is not None:
            ...
            state = checkpoint_utils.load_checkpoint_to_cpu(args.finetune_mol_model)
