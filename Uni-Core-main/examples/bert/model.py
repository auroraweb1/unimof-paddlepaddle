...
class BertModel(BaseUnicoreModel):
    ...
    def __init__(self, args, dictionary):
        ...
        self.embed_positions = Embedding(
            num_embeddings=args.max_seq_len, embedding_dim=args.encoder_embed_dim
        )
    ...
    def forward(
        ...
        **kwargs
        ...
        x += self.embed_positions.weight[: src_tokens.shape[1], :]
...
class BertLMHead(paddle.nn.Layer):
...
class BertClassificationHead(paddle.nn.Layer):
    ...
    def __init__(
        ...
        self.out_proj = (
            paddle.nn.Linear(in_features=inner_dim, out_features=num_classes),
            q_noise,
            qn_block_size,
        )
