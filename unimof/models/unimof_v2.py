...
class UniMOFV2Model(BaseUnicoreModel):
    ...
    def __init__(self, args, dictionary):
        ...
        self.classifier = ClassificationHead(
            args.encoder_embed_dim + self.args.hidden_dim * 5,
    ...
    def forward(
        ...
        **kwargs
        ...
        gas_embed = self.gas_embed(gas, gas_attr)
